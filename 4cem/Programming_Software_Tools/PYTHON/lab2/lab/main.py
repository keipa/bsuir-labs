...
def create_parser():
    ...
    parser.add_argument('-b', "--fixedblocks",  default='5')
    parser.add_argument('-l', "--fixedlines",  default='10')
    parser.add_argument('-s', "--symbols", default='5')
    parser.add_argument('-ls', "--lineseparator", default='\n')
    parser.add_argument('-t', "--blockseparator", default='\t')
    parser.add_argument('-i', "--input", default="strfiles/generated.txt")
