...
Data_selector   = 24
Screen_selector = 32
R_Mode_Code     = 40    ; Селектор дескриптора сегмента кода для возврата в режим реальных адресов.
...
; Готовим дополнительные дескрипторы для возврата в R-Mode:
    ...
    push cs
    pop ax
    shl eax,4       ; EAX = физический адрес сегмента кода (и всех остальных сегментов, т.к. это .com-программа)
    mov edx,0ffffh
