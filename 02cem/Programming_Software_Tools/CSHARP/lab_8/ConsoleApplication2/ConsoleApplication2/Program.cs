...
namespace Program
{
    class Exepts
    {
        static public int trythis(int a)
        {
            Console.WriteLine("Work trying");
            return 1;
        }

        static public int equalsnumber(int a)
        {
            Console.WriteLine("del equnum");
            return 1;
        }

        static public int subzero(int a)
        {
            Console.WriteLine("under the zero");
            return Math.Abs(a);
        }

        static public int zeroeq(int a)
        {
    ...
    class Ratio : IEquatable<Ratio>, IComparable<Ratio>
    {
        ...
        public event MyFirstdel CheckNull;
    ...
    class Program
    {
        static int Main()
        {
            Ratio r1 = new Ratio(4, 0);

            MyFirstdel one = new MyFirstdel(Exepts.trythis);
            MyFirstdel two = delegate(int a) {
                Console.WriteLine("Secnd trying");
                return a;
            };
            

            Func<int, int> tre = Exepts.trythis;


            MyFirstdel four = (int a) => Exepts.trythis(a);
            try
            {
                int e = r1.Up / r1.Down;
            }
