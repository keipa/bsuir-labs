...
//  GPLEX Version:  1.2.2
//  Machine:  DBODROV
//  DateTime: 4/25/2017 23:26:49
//  UserName: keipa
//  GPLEX input file <Pascal.Language.analyzer.lex - 4/25/2017 23:24:16>
...
#if BABEL
     internal sealed partial class PascalScanner : ScanBase, IColorScan
    {
...
#else  // BABEL
     internal sealed partial class PascalScanner : ScanBase
    {
        private ScanBuff buffer;
        int currentScOrd;  // start condition ordinal
#endif // BABEL
...
#if !NOFILES
     internal PascalScanner(Stream file) {
            SetSource(file); // no unicode option
        }   
#endif // !NOFILES

     internal PascalScanner() { }
