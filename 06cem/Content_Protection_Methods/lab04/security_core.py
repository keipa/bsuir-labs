...
def accessing(tgs_addr, client_name, server_name, session_key, session_ticket):
    ...
    print('TGS request: \n server ', server_name,
          ', \n auth ticket -', decode_authenticator(authenticator, session_key),
...
def requesting(command, server_addr, client_name, server_key, server_ticket):
    ...
    print("Resource request: ", '\n message -', command,
          ', \n auth ticket -', decode_authenticator(authenticator, server_key),
