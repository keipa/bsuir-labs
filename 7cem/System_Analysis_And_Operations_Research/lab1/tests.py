...
class DoubleSimplexTest(unittest.TestCase):
    ...
    def test1(self):
        ...
        assert correct_result == lab1.double_simplex(m, n, c, b, A, J, y, small_delta)
    ...
    def test2(self):
        ...
        assert correct_result == lab1.double_simplex(m, n, c, b, A, J, y, lab1.make_small_delta(c, A, y))
